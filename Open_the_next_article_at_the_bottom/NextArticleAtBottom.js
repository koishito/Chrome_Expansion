(function (){
  ...
  if(nextarticle != undefined){
    ...
    function floatBox_to(text) {
      ...
      mbox.style.cssText="position:fixed;top:50%;left:50%;transform:translate(-50%, -50%);"
      mbox.style.cssText+="border-radius:20px;padding:10px;text-align:center;z-index:19999;";
      mbox.style.opacity = '0.8';
      mbox.style.background = 'yellow';
      mbox.style.border = 'none';
